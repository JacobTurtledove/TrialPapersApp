...
struct RootView: View {
    ...
    @State private var crestMigrationError: String?
    ...
    var body: some View {
        ...
        .alert(
            "School Crest Migration Error",
            isPresented: Binding(
                get: { crestMigrationError != nil },
                set: { if !$0 { crestMigrationError = nil } }
            )
        ) {
            Button("OK", role: .cancel) {}
        } message: {
            Text(crestMigrationError ?? "")
        }
    }
    ...
    private func migrateLegacyCrests() {
        ...
        do {
            ...
            crestMigrationError = error.localizedDescription
        }
    }
}
